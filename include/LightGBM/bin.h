...
class BinMapper {
  ...
  */
  void FindBin(double* values, data_size_t num_values, size_t total_sample_cnt, int max_bin, int min_data_in_bin, int min_split_data, bool pre_filter, BinType bin_type,
